>>SOURCE FORMAT FREE
        ...
        WORKING-STORAGE SECTION.
            ...
            *> Connection request variables
            01 connectionData.
                02 senderUsername       PIC X(30).
                02 recipientUsername    PIC X(30).
        ...
        PROCEDURE DIVISION.
            ...
            CLOSE userInputFile, userOutputFile.
            STOP RUN.
        ...
        *> *****************Subroutines to be called*****************
            ...
            validateLoginCredentials.
                MOVE "N" TO foundAccount, endOfFile
                OPEN INPUT accountFile
                PERFORM UNTIL endOfFile = "Y"
                    READ accountFile INTO currentAccount
                        ...
                        NOT AT END
                            ...
                            IF FUNCTION TRIM(inputUsername) = FUNCTION TRIM(currentUsername) AND FUNCTION TRIM(inputPassword) = FUNCTION TRIM(currentPassword)
            ...
            postLoginMenu.
                ...
                PERFORM UNTIL exitMenu = "Y" OR quitProgram = "Y"
                    MOVE "1. Search for a job" TO messageVar; PERFORM displayAndWrite
                    MOVE "2. Find someone you know" TO messageVar; PERFORM displayAndWrite
                ...
                ELSE
                    ...
                    READ userInputFile INTO userInputRecord
                        AT END
                            EXIT PARAGRAPH
                        NOT AT END
                            MOVE userInputRecord TO queryLastName
                    END-READ
            ...
            saveProfile.
                    ...
                    READ profileFile INTO profileRecord AT END MOVE "Y" TO endOfFile
                        NOT AT END
                            IF FUNCTION TRIM(profileRecord(1:30)) = FUNCTION TRIM(inputUsername)
                                ...
                                MOVE experienceCount  TO tempProfileRecord(376:1)
                                MOVE educationCount   TO tempProfileRecord(377:1)
                                MOVE expTitle(1)      TO tempProfileRecord(378:50)
                                MOVE expCompany(1)    TO tempProfileRecord(428:50)
                                MOVE expDates(1)      TO tempProfileRecord(478:30)
                                MOVE expDesc(1)       TO tempProfileRecord(508:100)
                                MOVE expTitle(2)      TO tempProfileRecord(608:50)
                                MOVE expCompany(2)    TO tempProfileRecord(658:50)
                                MOVE expDates(2)      TO tempProfileRecord(708:30)
                                MOVE expDesc(2)       TO tempProfileRecord(738:100)
                                MOVE expTitle(3)      TO tempProfileRecord(838:50)
                                MOVE expCompany(3)    TO tempProfileRecord(888:50)
                                MOVE expDates(3)      TO tempProfileRecord(938:30)
                                MOVE expDesc(3)       TO tempProfileRecord(968:100)
                                MOVE eduDegree(1)     TO tempProfileRecord(1068:50)
                                MOVE eduUniversity(1) TO tempProfileRecord(1118:50)
                                MOVE eduYears(1)      TO tempProfileRecord(1168:20)
                                MOVE eduDegree(2)     TO tempProfileRecord(1188:50)
                                MOVE eduUniversity(2) TO tempProfileRecord(1238:50)
                                MOVE eduYears(2)      TO tempProfileRecord(1258:20)
                                MOVE eduDegree(3)     TO tempProfileRecord(1278:50)
                                MOVE eduUniversity(3) TO tempProfileRecord(1328:50)
                                MOVE eduYears(3)      TO tempProfileRecord(1378:20)
                ...
                MOVE "N" TO endOfFile
                PERFORM UNTIL endOfFile = "Y"
                    READ tempProfileFileHandle INTO tempProfileFileRecord AT END MOVE "Y" TO endOfFile
                        NOT AT END
                            WRITE profileRecord FROM tempProfileFileRecord
                    END-READ
                END-PERFORM
                CLOSE profileFile, tempProfileFileHandle.
                    ...
                    READ profileFile INTO profileRecord AT END MOVE "Y" TO endOfFile
                        NOT AT END
                            IF FUNCTION TRIM(profileRecord(1:30)) = FUNCTION TRIM(inputUsername)
                                ...
                                MOVE profileRecord(376:1)    TO experienceCount
                                MOVE profileRecord(377:1)    TO educationCount

                                MOVE profileRecord(378:50)   TO expTitle(1)
                                MOVE profileRecord(428:50) TO expCompany(1)
                                MOVE profileRecord(478:30)   TO expDates(1)
                                MOVE profileRecord(508:100)    TO expDesc(1)

                                MOVE profileRecord(608:50)  TO expTitle(2)
                                MOVE profileRecord(658:50)  TO expCompany(2)
                                MOVE profileRecord(708:30)  TO expDates(2)
                                MOVE profileRecord(738:100) TO expDesc(2)

                                MOVE profileRecord(838:50)  TO expTitle(3)
                                MOVE profileRecord(888:50)  TO expCompany(3)
                                MOVE profileRecord(938:30)  TO expDates(3)
                                MOVE profileRecord(968:100) TO expDesc(3)

                                MOVE profileRecord(1068:50) TO eduDegree(1)
                                MOVE profileRecord(1118:50) TO eduUniversity(1)
                                MOVE profileRecord(1168:20) TO eduYears(1)

                                MOVE profileRecord(1188:50) TO eduDegree(2)
                                MOVE profileRecord(1238:50) TO eduUniversity(2)
                                MOVE profileRecord(1258:20) TO eduYears(2)

                                MOVE profileRecord(1278:50) TO eduDegree(3)
                                MOVE profileRecord(1328:50) TO eduUniversity(3)
                                MOVE profileRecord(1378:20) TO eduYears(3)
                                MOVE "Y" TO endOfFile
                            END-IF
                    END-READ
                END-PERFORM
            ...
            findProfile.
                ...
                PERFORM UNTIL endOfFile = "Y"
                    READ profileFile INTO profileRecord AT END MOVE "Y" TO endOfFile
                        NOT AT END
                            IF (FUNCTION TRIM(profileRecord(31:30)) = FUNCTION TRIM(queryFirstName)) AND (FUNCTION TRIM(profileRecord(61:30)) = FUNCTION TRIM(queryLastName))
                ...
                MOVE "1. Send Connection Request" TO messageVar; PERFORM displayAndWrite
                MOVE "2. Back to Main Menu" TO messageVar; PERFORM displayAndWrite

                READ userInputFile INTO userInputRecord AT END MOVE "Y" TO quitProgram
                    NOT AT END MOVE userInputRecord to menuChoice
                END-READ
            ...
            sendConnectionRequest.
                ...
                OPEN INPUT connectionFile
                PERFORM UNTIL endOfFile = "Y"
                    READ connectionFile INTO existingConnectionRecord AT END MOVE "Y" TO endOfFile
                    NOT AT END
                        MOVE existingConnectionRecord TO connectionData
                        *> Check if I already sent them a request.
                        IF FUNCTION TRIM(senderUsername) = FUNCTION TRIM(originalUsername) AND FUNCTION TRIM(recipientUsername) = FUNCTION TRIM(targetUsername)
                            MOVE "You have already sent a connection request to this user." TO messageVar
                            PERFORM displayAndWrite
                            MOVE "Y" TO requestAlreadyExists
                            MOVE "Y" TO endOfFile *> Exit loop early
                        END-IF
                        *> Check if they already sent me a request.
                        IF FUNCTION TRIM(senderUsername) = FUNCTION TRIM(targetUsername) AND FUNCTION TRIM(recipientUsername) = FUNCTION TRIM(originalUsername)
                            MOVE "This user has already sent you a connection request." TO messageVar
                            PERFORM displayAndWrite
                            MOVE "Y" TO requestAlreadyExists
                            MOVE "Y" TO endOfFile *> Exit loop early
                        END-IF
                ...
                IF requestAlreadyExists = "N"
                    ...
                    MOVE connectionData TO connectionRecord
